...
export class MovieService {
  ...
  getSimilarMovies(movie_id: number, lang?: string): Observable<IMovie> {
    return this._http.get<IMovie>(
      `${this.basemovie}${movie_id}/similar?api_key=${this.apikey}&language=${lang}`
    );
  }
  ...
  getNowPlayinMovies(lang?: string): Observable<IMovie> {
    return this._http.get<IMovie>(
      `${this.basemovie}now_playing?api_key=${this.apikey}&language=${lang}`
    );
  }
  getSimilarTv(movie_id: number, lang?: string): Observable<IMovie> {
    return this._http.get<IMovie>(
      `${this.basetv}${movie_id}/similar?api_key=${this.apikey}&language=${lang}`
    );
  }
  getTopRatedTv(lang?: string): Observable<IMovie> {
    return this._http.get<IMovie>(
      `${this.basetv}top_rated?api_key=${this.apikey}&language=${lang}`
    );
  }
  getNewEpisodes(): Observable<IMovie> {
    return this._http.get<IMovie>(
      `${this.basetv}on_the_air?api_key=${this.apikey}`
    );
  }
  getEpisodeDetails(
    idshow: number,
